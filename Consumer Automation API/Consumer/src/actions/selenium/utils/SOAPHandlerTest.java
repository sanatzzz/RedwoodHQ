...
public class SOAPHandlerTest{
	...
	try{	System.out.println("wsdlPath :"+wsdlPath);
        ...
        System.out.println("test_case_name: "+test_case_name);
			...
			WsdlInterface[] wsdls = WsdlImporter.importWsdl(project, wsdlPath);
    ...
    public ArrayList <String> compareSOAPResponse(Map <String,String> expectedValues, String result , String xmlCompareOption , 
                                    ArrayList<String> ignoreTags,ArrayList<String> returnTags,String responseXmlPath){
                   ...
                   // (document.getElementsByTagName("ns0:mobileNumber")).item(0).setTextContent("123456");
                    ...
                    switch(xmlCompareOption){
                        ...
                        case "Parameter Comparison" :
                            ...
                            //    Iterator ArrayList<String> returnTags
                              //  {
                              //     taglist = document.getElementsByTagName(key);
                              //     ret =  list.item(0).getTextContent();
                             //   }
    ...
    public Map<String,String> getAPIDetailsFromDB(String test_case_name){
        
        return new DatabaseHandler().getAPIDetails(test_case_name);
    }
