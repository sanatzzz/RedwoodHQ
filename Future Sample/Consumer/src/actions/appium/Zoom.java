...
class Zoom {
	public void run(HashMap<String, String> params) throws Exception {
		...
		TouchAction action0 = new TouchAction(Driver.driver).press(x, y).moveTo(0, -yOffset).release();
		TouchAction action1 = new TouchAction(Driver.driver).press(x, y).moveTo(0, yOffset).release();
