...
class SOAPClassTest{
    public void run(HashMap<String, Object> params){
        /*
        	...
        	apiDetails = new SOAPHandler().getAPIDetailsFromDB(test_case_name);
        	...
        	ArrayList <String> apiReturn = new SOAPHandler().compareSOAPResponse(expectedValues,result,xmlCompareOption,ignoreTags,expectedResponse,returnTags);
